...
@section('content')
    <div class="content">
        <div class="container-fluid">
            <div class="row">
                <div class="col-md-12">
                    <form method="post"  action="{{route('equipments.update',$equipments->id)}}" autocomplete="off"
                        ...
                        <div class="card ">
                            <div class="card-header card-header-primary">
                                ...
                                <h4 class="card-title">{{ __('Edit equipment name') }}</h4>
                            ...
                            <div class="card-footer ml-auto mr-auto">
                                <button type="submit"  class="btn btn-primary">{{ __('Update equipment') }}</button>
                            </div>
                        </div>
                    </form>
                </div>
